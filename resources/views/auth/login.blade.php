...
@section('title', 'Connexion - Gestion Étudiants')
...
<div class="auth-page">
    <div class="auth-card">
        <div class="auth-header">
            ...
            <p class="auth-subtitle">Accédez à votre espace étudiant</p>
        </div>
        ...
        <div class="auth-footer">
            Nouveau parmi nous ? <a href="{{ route('register') }}">Créer un compte</a>
        </div>
    </div>
</div>
@endsection
